export const links = {
  docs: {
    ...
    sparkAirdrop: 'https://docs.spark.fi/defi-infrastructure/sparklend/borrowing',
  },
  sparkAirdropFormula: 'https://forum.makerdao.com/t/proposed-spark-pre-farming-airdrop-formula/21786',
