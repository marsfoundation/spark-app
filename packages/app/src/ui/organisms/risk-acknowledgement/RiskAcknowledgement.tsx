      ...
      <Alert variant="danger">
        <div className="max-w-[46ch] text-basics-black text-sm">
          ...
          {warning.type === 'liquidation-warning-set-collateral' &&
            'Disabling this asset as collateral puts you at risk of quick liquidation. You may lose all of your remaining collateral.'}
          {warning.type === 'liquidation-warning-e-mode-off' &&
            'Disabling E-Mode decreases health factor of your position and puts you at risk of quick liquidation. You may lose all of your collateral.'}
        </div>
      </Alert>
