...
export const buttonVariants = cva(
  cn(
    ...
    'focus-visible:bg-primary focus-visible:text-reskin-neutral-950 ',
    ...
    variants: {
      variant: {
        primary: cn(
          ...
          'active:before:bg-reskin-neutral-800 focus-visible:before:bg-primary',
          'before:inset-0 hover:before:bg-reskin-neutral-950 active:text-primary-inverse before:transition-colors',
        ...
        secondary: cn(
          'bg-reskin-neutral-950 text-primary-inverse active:bg-reskin-neutral-950',
          'hover:bg-reskin-neutral-800 active:text-primary-inverse',
        ...
        loading: 'cursor-wait bg-reskin-neutral-50 text-primary-inverse',
      },
      size: {
