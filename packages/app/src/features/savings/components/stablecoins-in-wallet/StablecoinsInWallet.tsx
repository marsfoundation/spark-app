    ...
    <Panel spacing="none">
      <div className={cn('flex flex-col gap-6 p-4 md:px-8 md:py-6', showConvertDialogButton && 'pb-0 md:pb-0')}>
        <div className="flex flex-row items-center gap-1">
          <h3 className="typography-heading-5 text-primary">Stablecoins in wallet</h3>
        </div>
        <DataTable
      ...
      {showConvertDialogButton && (
        <div className="flex w-full items-center justify-between gap-6 border-primary border-t p-4 md:px-8 md:py-6">
