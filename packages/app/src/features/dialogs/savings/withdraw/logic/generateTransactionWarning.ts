...
export function generateTransactionWarning({
  ...
  if (discrepancy.gte(100)) {
    return {
      text: `Market fluctuations can impact your transaction value, and you may be charged more than the withdraw amount by ${inputToken.format(discrepancy, { style: 'auto' })} DAI.`,
