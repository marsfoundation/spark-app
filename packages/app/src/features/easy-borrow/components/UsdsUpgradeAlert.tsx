      ...
      <p className="max-w-[82ch]">
        {variant === 'borrow' && (
          <>
            ...
            a separate action listed in the actions panel below. You will see your {dai} position on the myPortfolio,
            and your new {usds} balance will be reflected on the Cash&nbsp;&&nbsp;Savings page.
          </>
        )}
        {variant === 'success' && (
          <>
            Borrowing {usds} created a {dai} borrow position in Spark Lend. The borrowed {dai} was upgraded to {usds}.
            Check your {dai} position on the myPortfolio and your new {usds} balance on the Cash&nbsp;&&nbsp;Savings
            page.
          </>
        )}
      </p>
