      ...
      <p className="max-w-[82ch]">
        {variant === 'borrow' && (
          <>
            ...
            a separate action listed in the actions panel below. You will see your {dai} position on the dashboard, and
        ...
        {variant === 'success' && (
          <>
            ...
            Check your {dai} position on the dashboard and your new {usds} balance on the Cash&nbsp;&&nbsp;Savings page.
          </>
        )}
      </p>
    </Alert>
