...
export function RewardsDetails({ rewards, onClaim }: RewardsDetailsProps) {
  return (
    <div className="flex w-[calc(100vw-48px)] min-w-72 flex-col gap-4 p-4 text-tertiary text-xs lg:w-auto">
          ...
          {rewards.map(({ token, amount }) => (
            <div key={token.symbol} className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div className="font-semibold text-base text-primary-inverse tabular-nums">
